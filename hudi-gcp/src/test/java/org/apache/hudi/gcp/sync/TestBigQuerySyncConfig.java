...
public class TestBigQuerySyncConfig {
  ...
  public void testCopy() {
    ...
    bigQuerySyncConfig.manifestSourceUri = "gs://test-bucket/dwh/table_name/.hoodie/manifest/latest-snapshot.csv";
    ...
    assertEquals(copied.manifestSourceUri, bigQuerySyncConfig.manifestSourceUri);
  }
}
