...
package org.apache.hudi.gcp.util;

import org.apache.hudi.gcp.sync.BigQuerySyncConfig;
...
public class Utils {
  ...
  public static String BIGQUERY_MANIFEST_SOURCE_URI_OPT_KEY = "hoodie.datasource.bigquery_sync.manifest_source_uri";
  ...
  public static Properties configToProperties(BigQuerySyncConfig cfg) {
    ...
    properties.put(BIGQUERY_MANIFEST_SOURCE_URI_OPT_KEY, cfg.manifestSourceUri);
  ...
  public static BigQuerySyncConfig propertiesToConfig(Properties properties) {
    ...
    config.manifestSourceUri = properties.getProperty(BIGQUERY_MANIFEST_SOURCE_URI_OPT_KEY);
