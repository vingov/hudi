 ...
 */
public class BigQuerySyncConfig extends HoodieSyncConfig {
  ...
  @Parameter(names = {"--manifest-source-uri"}, description = "name of the source uri gcs path of the table", required = true)
  ...
  public BigQuerySyncConfig() {
    this(new TypedProperties());
  }

  public BigQuerySyncConfig(TypedProperties props) {
    super(props);
  }
  ...
  public static BigQuerySyncConfig copy(BigQuerySyncConfig cfg) {
    ...
    newConfig.manifestSourceUri = cfg.manifestSourceUri;
  ...
  public String toString() {
    return "BigQuerySyncConfig{datasetName='" + datasetName + "', tableName='" + tableName
        + "', projectId='" + projectId + "', sourceUri='" + sourceUri + "', manifestSourceUri='" + manifestSourceUri
